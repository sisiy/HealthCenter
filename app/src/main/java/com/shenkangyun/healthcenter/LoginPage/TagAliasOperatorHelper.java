...
public class TagAliasOperatorHelper {
            ...
            switch (msg.what){
                case DELAY_SEND_ACTION:
                    if(msg.obj !=null && msg.obj instanceof  TagAliasBean){
                        System.out.println("----------on delay time");
                        sequence++;
                        ...
                        if(context!=null) {
                            ...
                            System.out.println("---------#unexcepted - context was null");
                        }
                    }else{
                        System.out.println("----------#unexcepted - msg obj was incorrect");
                    }
                    break;
                case DELAY_SET_MOBILE_NUMBER_ACTION:
                    if(msg.obj !=null && msg.obj instanceof String) {
                        System.out.println( "--------retry set mobile number");
                        sequence++;
    ...
    public void handleAction(Context context, int sequence, String mobileNumber){
        ...
        System.out.println("--------sequence:"+sequence+",mobileNumber:"+mobileNumber);
    ...
    public void handleAction(Context context, int sequence, TagAliasBean tagAliasBean){
        ...
        if(tagAliasBean == null){
            System.out.println("---------tagAliasBean was null");
            return;
        }
        ...
        if(tagAliasBean.isAliasAction){
            switch (tagAliasBean.action){
                ...
                case ACTION_SET:
                    ...
                    break;
                default:
                    System.out.println("-----unsupport alias action type");
                    return;
            }
        }else {
            switch (tagAliasBean.action) {
                ...
                case ACTION_CLEAN:
                    ...
                    break;
                default:
                    System.out.println("-----------unsupport tag action type");
                    return;
            }
        }
    }
    ...
    public void onTagOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        System.out.println("------------action - onTagOperatorResult, sequence:"+sequence+",tags:"+jPushMessage.getTags());
        System.out.println("-------------tags size:"+jPushMessage.getTags().size());
        init(context);
        ...
        if(jPushMessage.getErrorCode() == 0){
            System.out.println("----------action - modify tag Success,sequence:"+sequence);
    ...
    public void onCheckTagOperatorResult(Context context, JPushMessage jPushMessage){
        int sequence = jPushMessage.getSequence();
        System.out.println("--------------action - onCheckTagOperatorResult, sequence:"+sequence+",checktag:"+jPushMessage.getCheckTag());
        init(context);
        //根据sequence从之前操作缓存中获取缓存记录
        TagAliasBean tagAliasBean = (TagAliasBean)setActionCache.get(sequence);
        if(tagAliasBean == null){
        ...
        if(jPushMessage.getErrorCode() == 0){
            System.out.println("tagBean:"+tagAliasBean);
            setActionCache.remove(sequence);
    ...
    public void onAliasOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        if(jPushMessage.getErrorCode() == 0){
            System.out.println("---------------------action - modify alias Success,sequence:"+sequence);
            setActionCache.remove(sequence);
...
//            ExampleUtil.showToast(logs, context);
    ...
    public void onMobileNumberOperatorResult(Context context, JPushMessage jPushMessage) {
        int sequence = jPushMessage.getSequence();
        System.out.println("action - onMobileNumberOperatorResult, sequence:"+sequence+",mobileNumber:"+jPushMessage.getMobileNumber());
        init(context);
        if(jPushMessage.getErrorCode() == 0){
            System.out.println("action - set mobile number Success,sequence:"+sequence);
            setActionCache.remove(sequence);
        }else{
